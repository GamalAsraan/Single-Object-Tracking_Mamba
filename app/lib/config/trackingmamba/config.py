...
"""
Default config for TrackingMamba (Kaggle / aerial / tiny-unidirectional).
"""
cfg = edict()

# MODEL
cfg.MODEL = edict()
cfg.MODEL.PRETRAIN_FILE = ""           # train from scratch on Kaggle
...
cfg.MODEL.BACKBONE.TYPE = "vim_tiny_192"
cfg.MODEL.BACKBONE.STRIDE = 16
cfg.MODEL.BACKBONE.EMBED_DIM = 192
...
cfg.DATA.TRAIN.DATASETS_NAME = ["AERIAL"]
cfg.DATA.TRAIN.DATASETS_RATIO = [1]
cfg.DATA.TRAIN.SAMPLE_PER_EPOCH = 20000
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["AERIAL_val"]   # File #12 fix: dispatch to split='val' (was ["AERIAL"])
cfg.DATA.VAL.DATASETS_RATIO = [1]
cfg.DATA.VAL.SAMPLE_PER_EPOCH = 2000
